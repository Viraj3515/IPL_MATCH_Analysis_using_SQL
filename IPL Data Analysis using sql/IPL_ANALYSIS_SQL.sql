...
**--Create a database with the name of SQLproject

**--Imoprting the IPL_BALL datset from the coumputer

BULK INSERT IPL_BALL
FROM 'G:\IPL_EDA_Using_SQL-main\Datasets\IPL_BALL.csv'
WITH ( format ='csv',
    FIRSTROW = 2,
    FIELDTERMINATOR = ',',
    ROWTERMINATOR = '\n'
...
***--update the datatype of date column which exists in IPL_MATCHES dataset and import the file from coumputer

BULK INSERT IPL_MATCHES
FROM 'G:\IPL_EDA_Using_SQL-main\Datasets\IPL_MATCHES.csv'
WITH ( format ='csv',
    FIRSTROW = 1,
    FIELDTERMINATOR = ',',
    ROWTERMINATOR = '\n'
